...
export const AUTOMATION_TEMPLATES: Record<TemplateSlug, AutomationTemplateDefinition> = {
  welcome_message: {
    ...
    description: 'Responde al primer contacto de un aspirante con un saludo.',
  ...
  out_of_office: {
    ...
    description: 'Contesta de noche y en fin de semana para que nadie se quede esperando.',
  ...
  lead_qualifier: {
    slug: 'lead_qualifier',
    name: 'Calificador de aspirante',
    description: 'Pregunta programa de interés y escolaridad antes de pasar a un asesor.',
  ...
  follow_up_reminder: {
    ...
    description: 'Avisa al asesor si un aspirante no ha respondido en 24 horas.',
    trigger_type: 'new_message_received',
    trigger_config: {},
    steps: [
      {
